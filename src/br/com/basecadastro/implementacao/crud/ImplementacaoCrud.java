...
import br.com.basecadastro.crud.InterfaceCrud;
import br.com.basecadastro.hibernate.session.HibernateUtil;
...
public class ImplementacaoCrud<T> implements InterfaceCrud<T> {
	...
	public List<T> findListByQueryDinamica(String query, int iniciaNoRegistro, int maximoResultado) throws Exception {
		...
		lista = sessionFactory.getCurrentSession()
				.createQuery(query).setFirstResult(iniciaNoRegistro)
	 ...
	 * TestUnit Ok
	 */
	public List<Object[]> getListArrayObjectSQLDinamica(String sql) throws Exception {
		validaSessionFactory();
